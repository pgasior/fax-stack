 ...
 */
    ...
    $formdata->newRule('oldpwd', NULL, FR_STRING, MIN_PASSWD_SIZE, MAX_PASSWD_SIZE, $LANG['REGWARN_PASS'], true);
	$formdata->newRule('newpwd', NULL, FR_STRING, MIN_PASSWD_SIZE, MAX_PASSWD_SIZE, $LANG['REGWARN_PASS'], true);
    $formdata->newRule('conpwd', NULL, FR_STRING, MIN_PASSWD_SIZE, MAX_PASSWD_SIZE, $LANG['REGWARN_PASS'], true);
	...
	display_template('pwdexpired.tpl',	$usmarty);
