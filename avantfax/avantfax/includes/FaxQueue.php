	...
	public function faxalter($user, $jid, array $operations) {
		...
		foreach ($operations as $op => $value) {
			switch ($op) {
				...
				case 'sendtime':	$ops .= ' -a '.escapeshellarg($value); break;
				case 'destination':	$ops .= ' -d '.escapeshellarg($value); break;
				case 'killtime':	$ops .= ' -k '.escapeshellarg($value); break;
				case 'device':		$ops .= ' -m '.escapeshellarg($value); break;
				case 'priority':	$ops .= ' -P '.escapeshellarg($value); break;
				case 'tries':		$ops .= ' -t '.escapeshellarg($value); break;
			}
		}
