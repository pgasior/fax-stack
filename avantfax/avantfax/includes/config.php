 ...
 */
	...
	define('AVFX_LIB_DIR',		$INSTALLDIR.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR);
	...
	if (!defined('WHITEPAGES'))
        define('WHITEPAGES', 'https://www.whitepages.com/phone/');
	...
	set_include_path(get_include_path() . PATH_SEPARATOR . $INSTALLDIR.DIRECTORY_SEPARATOR.'includes');
