...
<div align="center">
	<p><label for="regexp">{$LANG.ASSIGN_CNAME}:</label> <input type="text" onkeyup="myfilter.query()" name="regexp" id="regexp" style="width: 22em" />
{if $lookup_whitepages}
	&nbsp;<a href="{$WHITEPAGES}{$lookup_whitepages}" target="_blank">{html_image file="images/viewfax.png" height="20" width="20" title=$LANG.SEARCH_WHITEPAGES}</a>
{/if}
	</p>
	<br />
