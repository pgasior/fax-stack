...
<div class="miniTableForm" align="left">
	...
	<p><label for="killtime">{$LANG.FAX_KILLTIME}:</label>
		<div style="float:left">{$LANG.NOW} + <input type="text" name="killtime" id="killtime" value="{$fvalues.killtime}" style="width: 2em" maxlength="2" /> {html_options name="killtime_unit" id="killtime_unit" selected=$fvalues.killtime_unit options=$units}
		</div>
	</p>
	<br />
