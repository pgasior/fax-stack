...
<div class="success" align="center">
	<br />{$message}<br /><br />
	<input type="button" class="inputsubmit" value="{$LANG.BACK}" onclick="parent.location.href='conf_barcoderoute.php'" />
	<br /><br />
</div>
{else}
...
<div class="miniTableForm">
	<p><label for="barcode">{$LANG.BARCODEROUTE_BARCODE}{required}:</label> <input type="text" name="barcode" id="barcode" value="{$fvalues.barcode}" /></p>
...
{else}
	<input type="hidden" name="barcode_id" value="{$fvalues.barcode_id}" />
