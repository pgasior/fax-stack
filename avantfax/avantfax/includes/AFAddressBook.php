...
class AFAddressBook
{
	...
	public function inc_faxfrom() {
		...
		$faxfrom = array_key_exists('faxfrom', $this->fax_array) ? (int) $this->fax_array['faxfrom']+1 : 1;
	...
	public function inc_faxto() {
		...
		$faxto = array_key_exists('faxto', $this->fax_array) ? (int) $this->fax_array['faxto']+1 : 1;
