 ...
 */
	...
	define('AFDB_USER',		'$MYSQL_USER');	// username
	define('AFDB_PASS',		'$MYSQL_PASSWORD');		// password
	define('AFDB_NAME',		'$MYSQL_DATABASE');	// database name
	define('AFDB_HOST',		'mariadb');	// database host
	...
	$HYLASPOOL			= '/var/spool/hylafaxplus';
...
//	define('WHITEPAGES', "http://privatpersoner.eniro.se/query?stq=0&searcharea=&what=wphone&searchword="); // Vita sidorna Eniro, Sverige
    ...
    // Set the session cookie lifetime in seconds.  Zero means the session will expire automatically when the brower is closed.
